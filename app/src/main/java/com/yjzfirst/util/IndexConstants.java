...
public class IndexConstants {
    ...
    public static final String CHECKDELIVERYFORM="/app/sale_delivery";
    public static final String CHECKDELIVERYPRODUCT="/app/sale_delivery_check_product";

    public static final String CHECKLIBRARY="/app/stock_location";
